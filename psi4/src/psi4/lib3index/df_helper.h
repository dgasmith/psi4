...
public:
    ...
    void get_integral(std::string name, SharedMatrix M);
    
    // obtain block of transformed integral, however you want
    void get_integral(std::string name, SharedMatrix M, std::pair<size_t, size_t> a1);
    void get_integral(std::string name, SharedMatrix M, std::pair<size_t, size_t> a1,
    ...
    SharedMatrix get_integral(std::string name);
    SharedMatrix get_integral(std::string name, std::pair<size_t, size_t> a1);
    SharedMatrix get_integral(std::string name, std::pair<size_t, size_t> a1,
      std::pair<size_t, size_t> a2);
    SharedMatrix get_integral(std::string name, std::pair<size_t, size_t> a1,
      std::pair<size_t, size_t> a2, std::pair<size_t, size_t> a3);
