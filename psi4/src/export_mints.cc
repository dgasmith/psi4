...
void export_mints(py::module& m)
{
    ...
    py::class_<Wavefunction, std::shared_ptr<Wavefunction>>(m, "Wavefunction", "docstring",
        ...
        .def("nalpha", &Wavefunction::nalpha, "docstring")
        .def("nbeta", &Wavefunction::nbeta, "docstring")
        .def("set_oeprop", &Wavefunction::set_oeprop,
             "Associate an OEProp object with this wavefunction")
        .def("oeprop", &Wavefunction::get_oeprop,
             "Get the OEProp object associated with this wavefunction")
    ...
    py::class_<scf::HF, std::shared_ptr<scf::HF>, Wavefunction>(m, "HF",
                                                                "A HF and DFT Wavefunction object")
        ...
        .def("set_sad_fitting_basissets", &scf::HF::set_sad_fitting_basissets,
             "Sets the SAD fitting basis set.")
        ...
        .def("semicanonicalize", &scf::HF::semicanonicalize,
             "Semicanonicalize the orbitals, valid for ROHF only.");
